...
dish_pizza.add_ingredient_dependency("queijo mussarela", 1)
dish_pizza.add_ingredient_dependency("tomate", 1)
dish_pizza.add_ingredient_dependency("farinha de trigo", 1)
print(dish_pizza.get_restrictions)
